...
urlpatterns = [
    ...
    path('addYesNoAns/<int:id>/<str:answer>/',addYesNoAns,name="addYesNoAns"),
    path('removeYesNoAns/<int:id>/<str:answer>/',removeYesNoAns,name="removeYesNoAns"),
    path("setRange/<int:id>/<int:rv>/<int:nrv>/", setRange, name="setRange"),
